...
Six menu items on any feature phone. Menu items 4–6 form the **Community Resource Platform (CRP)**, a bundled marketplace and advisory service:
...
[Soil sensor] → [YPS model] → [USSD *165*ACP#]
                                    ...
                                    ├─ 3. Balance
                                    ├─ 4. Market price  ─── CRP live feed
                                    ├─ 5. Sell produce  ─── CRP auto-match
                                    └─ 6. Ask Mavuno    ─── CRP AI agronomist
                                                              ↓
